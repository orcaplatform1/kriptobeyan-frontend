...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/desteklenen-borsalar", priority: 0.6, changeFrequency: "monthly" },
  { path: "/isletmeler", priority: 0.7, changeFrequency: "monthly" },
  { path: "/mali-musavirler", priority: 0.7, changeFrequency: "monthly" },
